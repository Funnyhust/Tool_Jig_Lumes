...
// Địa chỉ bắt đầu trong Flash memory (EEPROM emulated) để lưu các giá trị
// threshold
#define SETTING_FRAME_ID 0xD3

// Mỗi channel: 4 bytes (voltage) + 12 bytes (3 current * 4) + 12 bytes (3 power
// * 4) = 28 bytes Địa chỉ bắt đầu của mỗi channel trong EEPROM Channel 0: 0x00,
// Channel 1: 0x1C (28), Channel 2: 0x38 (56), Channel 3: 0x54 (84)
